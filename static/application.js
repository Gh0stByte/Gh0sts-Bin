...
haste.prototype.fullKey = function() {
  this.configureKey(['new', 'duplicate', 'twitter', 'raw', 'copy', 'url']);
};
...
// Copy Document URL
haste.prototype.copyURL = function() {
  if(this.doc.locked) {
    var currentData = window.location.href;
    var $temp = $("<input>");
    $("body").append($temp);
    $temp.val(currentData).select();
    document.execCommand("copy");
...
haste.prototype.configureButtons = function() {
  ...
  this.buttons = [
    ...
    },
    {
      ...
      shortcut: function(evt) {
        return _this.doc.locked && evt.ctrlKey && evt.keyCode === 67;
      },
    ...
    },
    {
      ...
      shortcut: function(evt) {
        return _this.doc.locked && evt.ctrlKey && evt.keyCode === 88;
      },
      shortcutDescription: 'control + x',
      action: function() {
        _this.copyURL();
      }
    }
...
haste.prototype.configureShortcuts = function() {
  ...
  $(document.body).keydown(function(evt) {
    var button;
    for (var i = 0 ; i < _this.buttons.length + 1; i++) {
